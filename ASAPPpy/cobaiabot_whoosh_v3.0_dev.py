...
def chatbot_interface(interaction, word2vec_model, fasttext_model, ptlkb64_model, glove300_model, numberbatch_model):
	...
	# TODO: The STS model class can't perform feature selection but can't use a model that uses it yet.
	# TODO: The model being loaded serves is only for testing and should be changed in the final version.
