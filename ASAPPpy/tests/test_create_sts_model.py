...
import ASAPPpy.scripts.tools as tl
from ASAPPpy.sts_model import STSModel
from ASAPPpy.scripts.xml_reader import read_xml, read_xml_no_attributes
...
if system_mode == 4 or system_mode == 5:
	...
	train_pairs.extend(read_xml(ROOT_PATH + '/datasets/assin/assin2/assin2-dev.xml', need_labels=True))
...
if feature_selection_flag:
	...
	if feature_selection_assin1:
		...
		dev_pairs = read_xml(ROOT_PATH + '/datasets/assin/assin2/assin2-dev.xml', need_labels=True)
...
if predict_similarity:
	...
	if test_dataset_flag == 0:
		test_path = ROOT_PATH + '/datasets/assin/assin1/assin-ptbr-test.xml'

	if test_dataset_flag == 1:
		test_path = ROOT_PATH + '/datasets/assin/assin1/assin-ptpt-test.xml'

	if test_dataset_flag == 2:
		test_path = ROOT_PATH + '/datasets/assin/assin2/assin2-blind-test.xml'
